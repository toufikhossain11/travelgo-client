...
import AIRelatedPackages from "@/src/components/package-details/AIRelatedPackages";import FAQSection from "@/src/components/package-details/FAQSection";
...
export default function PackagePage({ params }: PackagePageProps) {
  const pkg = packageDetails.find((p) => p.id === params.id);
  if (!pkg) notFound();
  ...
  return (
    <main>
      ...
      <div className="mx-auto max-w-7xl px-5 md:px-8">
        ...
        <AIRelatedPackages currentId={pkg.id} category={pkg.category} />      <div className="mx-auto max-w-7xl px-5 md:px-8">
